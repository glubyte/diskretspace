...
unsigned char createSwapChain(vksdl_shit* vksdlshit)
{
	...
	swapChainInfo.imageExtent = theExtent;
...
unsigned char createFramebuffers(vksdl_shit* vksdlshit)
{
	...
	framebufferInfo.width = (uint32_t)1600;
	framebufferInfo.height = (uint32_t)900;
